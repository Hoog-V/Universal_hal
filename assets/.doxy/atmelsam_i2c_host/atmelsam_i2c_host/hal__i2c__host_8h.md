...
| Type | Name |
| ---: | :--- |
| define  | [**I2C\_HOST\_DEINIT**](hal__i2c__host_8h.md#define-i2c_host_deinit) (i2c\_peripheral\_num) `/* multi line expression */`<br> |
| define  | [**I2C\_HOST\_INIT**](hal__i2c__host_8h.md#define-i2c_host_init) (i2c\_peripheral\_num, clock\_sources, periph\_clk\_freq, baud\_rate\_freq, extra\_configuration\_options) `/* multi line expression */`<br> |
| define  | [**I2C\_HOST\_READ\_BLOCKING**](hal__i2c__host_8h.md#define-i2c_host_read_blocking) (i2c\_peripheral\_num, addr, read\_buff, size) `/* multi line expression */`<br> |
| define  | [**I2C\_HOST\_READ\_NON\_BLOCKING**](hal__i2c__host_8h.md#define-i2c_host_read_non_blocking) (i2c\_peripheral\_num, addr, read\_buff, size) `/* multi line expression */`<br> |
| define  | [**I2C\_HOST\_WRITE\_BLOCKING**](hal__i2c__host_8h.md#define-i2c_host_write_blocking) (i2c\_peripheral\_num, addr, write\_buff, size, stop\_bit) `/* multi line expression */`<br> |
| define  | [**I2C\_HOST\_WRITE\_NON\_BLOCKING**](hal__i2c__host_8h.md#define-i2c_host_write_non_blocking) (i2c\_peripheral\_num, addr, write\_buff, size, stop\_bit) `/* multi line expression */`<br> |
